...
class Yaml
{
    ...
    /**
     * Setting this to true will force dump to enclose any string value in
    ...
    /**
     * Setting this to true will force load to use yaml_load function when
     * possible. False by default.
     * @var bool
     */
    public $setting_use_yaml_is_possible = false;
    ...
    /**
     * Load a valid YAML file to array.
     *
     * @param string $file
     * @return array
     */
     ...
     *  Usage:
     *  ```
     *   $array = Yaml::loadString("0: hello world\n");
     *   print_r($array);
     *  ```
     * @access public
     ...
     *
     * Indent's default is 2 spaces, wordwrap default is 40 characters.  And
    ...
    public function dump($array, int $indent = null, int $wordwrap = null): string
    {
        ...
        if (empty($indent) or !\is_numeric($indent)) {
            $this->_dumpIndent = 2;
        } else {
            $this->_dumpIndent = $indent;
        }

        if (empty($wordwrap) or !\is_numeric($wordwrap)) {
