...
class ParseTest extends TestCase
{
  ...
  public function testMergeHashKeys()
  {
    ...
    $Actual = yaml_load_file(__DIR__ . DIRECTORY_SEPARATOR . 'indent_1.yaml');
  ...
  {
    $this->assertEquals(array(
      "This", array("Is", "Getting", array("Ridiculous", "Guys")),
  ...
  {
    $this->assertEquals(array(
      "name" => "mark", "age" => "older than chris",
  ...
  {
    $Quotes = Yaml::loader(__DIR__ . DIRECTORY_SEPARATOR . 'quotes.yaml');
    $this->assertEquals(
      array('html_tags' => array('<br>', '<p>'), 'html_content' => array('<p>hello world</p>', 'hello<br>world'), 'text_content' => array('hello world')),
      $Quotes
    );
  }
  ...
  {
    $Failing = Yaml::loader(__DIR__ . DIRECTORY_SEPARATOR . 'failing1.yaml');
    $this->assertSame(
      array('MyObject' => array('Prop1' => array('key1:val1'))),
      $Failing
    );
  }
  ...
  {
    $Expected = 'bar';
    $Actual = yaml_load_file(__DIR__ . DIRECTORY_SEPARATOR . 'comments.yaml');
